...
fn main() -> Result<()> {
    ...
    let det_model_path = PathBuf::from("data/frozen_east_text_detection.pb");
    let rec_model_path = PathBuf::from("data/crnn.onnx");
    let voc_path = PathBuf::from("data/alphabet_36.txt");
